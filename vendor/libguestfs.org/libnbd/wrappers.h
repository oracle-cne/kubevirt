...
/* Older libnbd headers do not provide the extent64 callback types.
 * The generated bindings already gate the corresponding functions on
 * LIBNBD_HAVE_* macros, so a local fallback type definition is enough
 * to keep the package buildable against those older headers.
 */
