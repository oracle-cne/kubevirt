...
/* libnbd 1.6 lacks the 64-bit extent callback API. Define the newer
 * types so the generated bindings still compile and can fall back to
 * the legacy block_status callback at runtime.
 */
typedef struct {
  uint64_t length;
  uint32_t flags;
