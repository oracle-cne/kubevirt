 ...
 * used by newer generated Go bindings. The wrapper implementations below
 * already degrade missing APIs to ENOTSUP, so provide matching typedefs
 * here to keep the bindings buildable against those older headers.
 */
