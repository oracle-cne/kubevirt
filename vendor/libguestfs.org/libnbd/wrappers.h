...
/* Older libnbd headers used in some RPM build environments do not provide
 * the 64-bit extent callback types. The generated bindings already return
 * ENOTSUP when the corresponding APIs are unavailable, so provide local type
 * shims to keep the package buildable against those headers.
 */
