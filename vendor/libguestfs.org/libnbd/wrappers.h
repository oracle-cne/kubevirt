...
/* libnbd < 1.18 does not define the 64-bit block status callback types.
 * The generated bindings already return ENOTSUP for those missing APIs, but
 * they still need placeholder type definitions to compile against old headers.
 */
