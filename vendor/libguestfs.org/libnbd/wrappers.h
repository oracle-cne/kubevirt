...
/* Older libnbd headers do not define the 64-bit extent callback API types.
 * The generated wrappers already gate use of the corresponding functions with
 * LIBNBD_HAVE_* macros, so provide minimal fallback type definitions here to
 * keep cgo compilation working against those older headers.
 */
