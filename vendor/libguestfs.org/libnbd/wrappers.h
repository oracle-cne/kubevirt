...
/* Older libnbd headers do not provide the 64-bit block status types.
 * The generated wrappers already handle missing functions at runtime,
 * so provide local stand-ins to keep the bindings buildable.
 */
