                             ...
                             int *error)
{
  ...
  return chunk_callback ((long *)user_data, (void *)subbuf, count, offset, status, error);
}
...
{
  // golang isn't const-correct, casts avoid warnings here:
  return debug_callback ((long *)user_data, (char *)context, (char *)msg);
}
...
{
  // golang isn't const-correct, casts avoid warnings here:
  return extent_callback ((long *)user_data, (char *)metacontext, offset, entries, nr_entries, error);
}
...
{
  // golang isn't const-correct, casts avoid warnings here:
  return list_callback ((long *)user_data, (char *)name, (char *)description);
}
...
{
  // golang isn't const-correct, casts avoid warnings here:
  return context_callback ((long *)user_data, (char *)name);
}
