...
%global local_rpm_prefix %{nil}
%global local_rpm_suffix %{nil}
%global launcher_extra_packages %{nil}
%global handler_extra_packages %{nil}
%if 0%{?use_local_rpms}
%global local_rpm_prefix /shared/
%global local_rpm_suffix .rpm
%global launcher_extra_packages --build-arg EXTRA_PACKAGES="/shared/kubevirt-container-disk-%{version}-%{release}.%{_arch}.rpm /shared/kubevirt-freezer-%{version}-%{release}.%{_arch}.rpm /shared/kubevirt-probe-%{version}-%{release}.%{_arch}.rpm /shared/kubevirt-launcher-monitor-%{version}-%{release}.%{_arch}.rpm"
%global handler_extra_packages --build-arg EXTRA_PACKAGES="/shared/kubevirt-container-disk-%{version}-%{release}.%{_arch}.rpm /shared/kubevirt-chroot-%{version}-%{release}.%{_arch}.rpm"
%endif
...
podman build \
    ...
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-api-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{build_args} \
...
podman build \
    --network=host \
    --build-arg BASE_IMAGE=%{base_image} \
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-controller-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{build_args} \
...
podman build \
    --network=host \
    --build-arg BASE_IMAGE=%{base_image} \
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-operator-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{build_args} \
...
podman build \
    --network=host \
    --build-arg BASE_IMAGE=%{base_image} \
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-exportproxy-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{build_args} \
...
podman build \
    --network=host \
    --build-arg BASE_IMAGE=%{base_image} \
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-exportserver-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{build_args} \
...
podman build \
    ...
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-launcher-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{launcher_extra_packages} \
    %{build_args} \
...
podman build \
    --network=host \
    --build-arg BASE_IMAGE=%{base_image_full} \
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-handler-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{handler_extra_packages} \
    %{build_args} \
...
podman build \
    --network=host \
    --build-arg BASE_IMAGE=%{base_image_full} \
    --build-arg PACKAGE=%{local_rpm_prefix}kubevirt-libguestfs-appliance-%{version}-%{release}.%{_arch}%{local_rpm_suffix}\
    %{build_args} \
