...
podman save -o virt_controller.tar %{registry}/virt-controller:%{version}
...
podman save -o virt_exportproxy.tar %{registry}/virt-exportproxy:%{version}
...
podman save -o virt_exportserver.tar %{registry}/virt-exportserver:%{version}
%install
